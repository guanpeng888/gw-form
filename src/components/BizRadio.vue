<template>
  <div :class="[ctrlStyle === 'iview' ? 'ivu-radio-list-wrap-style' : 'radio-list-wrap-style']">
        ...
        >
          <span class="radio-item-style" v-for="(item , idx) in radioItems" :key="idx">
            <Radio v-if="!readonly" :label="idx" :true-value="selectedIndex === idx">
              <span class="labelText"><i v-if="isShowCode">{{item[bizViewCode]}}&nbsp;</i>{{item[itemValueName]}}</span>
            </Radio>
